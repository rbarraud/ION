# assumed to run from /<project directory>/sim/modelsim/ion_application
vlib work
...
vcom -reportprogress 300 -work work ../../../src/rtl/buses/ion_wishbone_arbiter.vhdl
...
vcom -reportprogress 300 -work work ../../../src/application/interfaces/ion_sram_interface.vhdl
vcom -reportprogress 300 -work work ../../../src/application/interfaces/ion_gpio_interface.vhdl
...
vcom -reportprogress 300 -work work ../../../src/testbench/ion_application_tb.vhdl

# Set up the simulation.
vsim -t ps work.ion_application_tb(testbench)

# Run a script that will set up a neat waveform window for us...
do ./ion_application_tb_wave.do
